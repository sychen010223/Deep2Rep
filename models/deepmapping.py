...
class DeepMapping2(nn.Module):
    ...
    def __init__(self, n_points, loss_fn, rotation_representation='quaternion', n_samples=35, device='cuda', dim=[3, 64, 256, 1024, 1024, 256, 64, 1], alpha=0.1, beta=0.1):
