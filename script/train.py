...
if opt.dataset == "KITTI":
    ...
    train_dataset = replica(opt.data_dir, opt.traj, opt.voxel_size, init_pose=init_pose, group_size=opt.group_size, pairwise_pose=pairwise_pose)
    eval_dataset = replicaEval(train_dataset)
